...
/**
 * This comparator is an n-gram similarity model which employs the Jaccard
 * similarity coefficient. It is the generalization of the Ferret measure
 * (Lyon et al., 2004). While Ferret uses trigrams only, this measure
 * allows to use any n-grams for comparison.
 * 
 * C. Lyon, R. Barrett, and J. Malcolm. A theoretical basis to the automated
	...
	extends TextSimilarityMeasureBase
{
	...
	{
		// Get n-grams
		Set<List<String>> ngrams1 = getNGrams(
				Arrays.asList(stringList1.toArray(new String[] {})));
		Set<List<String>> ngrams2 = getNGrams(
				Arrays.asList(stringList2.toArray(new String[] {})));

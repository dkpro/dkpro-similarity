...
public class WordPair_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.dkpro.similarity.type.WordPair");
  ...
  public String getWord1(int addr) {
      ...
      jcas.throwFeatMissing("Word1", "org.dkpro.similarity.type.WordPair");
  ...
  public String getWord2(int addr) {
      ...
      jcas.throwFeatMissing("Word2", "org.dkpro.similarity.type.WordPair");
  ...
  public int getPos1(int addr) {
      ...
      jcas.throwFeatMissing("Pos1", "org.dkpro.similarity.type.WordPair");
  ...
  public int getPos2(int addr) {
      ...
      jcas.throwFeatMissing("Pos2", "org.dkpro.similarity.type.WordPair");
  ...
  public int getToken1(int addr) {
      ...
      jcas.throwFeatMissing("Token1", "org.dkpro.similarity.type.WordPair");
  ...
  public int getToken2(int addr) {
      ...
      jcas.throwFeatMissing("Token2", "org.dkpro.similarity.type.WordPair");

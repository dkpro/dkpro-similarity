...
public class SemanticRelatedness_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.tudarmstadt.ukp.similarity.type.SemanticRelatedness");
  ...
  public String getMeasureType(int addr) {
      ...
      jcas.throwFeatMissing("MeasureType", "de.tudarmstadt.ukp.similarity.type.SemanticRelatedness");
  ...
  public double getRelatednessValue(int addr) {
      ...
      jcas.throwFeatMissing("RelatednessValue", "de.tudarmstadt.ukp.similarity.type.SemanticRelatedness");
  ...
  public String getMeasureName(int addr) {
      ...
      jcas.throwFeatMissing("MeasureName", "de.tudarmstadt.ukp.similarity.type.SemanticRelatedness");
  ...
  public int getWordPair(int addr) {
      ...
      jcas.throwFeatMissing("WordPair", "de.tudarmstadt.ukp.similarity.type.SemanticRelatedness");
  ...
  public String getTerm1(int addr) {
      ...
      jcas.throwFeatMissing("Term1", "de.tudarmstadt.ukp.similarity.type.SemanticRelatedness");
  ...
  public String getTerm2(int addr) {
      ...
      jcas.throwFeatMissing("Term2", "de.tudarmstadt.ukp.similarity.type.SemanticRelatedness");
  ...
  public int getAnnotationPair(int addr) {
      ...
      jcas.throwFeatMissing("AnnotationPair", "de.tudarmstadt.ukp.similarity.type.SemanticRelatedness");
  ...
  public SemanticRelatedness_Type(JCas jcas, Type casType) {
    ...
    casFeat_WordPair = jcas.getRequiredFeatureDE(casType, "WordPair", "de.tudarmstadt.ukp.similarity.type.WordPair", featOkTst);
    ...
    casFeat_AnnotationPair = jcas.getRequiredFeatureDE(casType, "AnnotationPair", "de.tudarmstadt.ukp.similarity.type.AnnotationPair", featOkTst);

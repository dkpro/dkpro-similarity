...
import dkpro.similarity.uima.resource.structure.PosNGramJaccardResource;
import dkpro.similarity.uima.resource.structure.StopwordNGramContainmentMeasureResource;
import dkpro.similarity.uima.resource.structure.TokenPairDistanceResource;
import dkpro.similarity.uima.resource.structure.TokenPairOrderingResource;
import dkpro.similarity.uima.resource.style.AvgCharactersPerTokenResource;
import dkpro.similarity.uima.resource.style.AvgTokensPerSentenceResource;
import dkpro.similarity.uima.resource.style.FunctionWordFrequenciesMeasureResource;
import dkpro.similarity.uima.resource.style.MTLDResource;
